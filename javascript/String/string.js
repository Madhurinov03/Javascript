...
var trimStart = str.trimStart("J");
document.write("<br>" + trimStart);
//string trimStart will trim whitespace only from start of a string.

var trimEnd = str.trimEnd("e");
document.write("<br>" + trimEnd);
//string trimEnd will trim whitespace only from end of a string.
